...
class Mapa:
    ...
    def crear_habitacion(self, id, nombre, id_vecinos, objetos): # COMPLETAR
        ...
        for instancia in self.habitaciones_creadas:
    ...
    def registrar_vecino(self, habitacion: Habitacion, vecino: Habitacion): # COMPLETAR
        ...
        if vecino not in habitacion.conexiones and habitacion not in vecino.conexiones:
    ...
    def descartar_habitacion(self, habitacion: Habitacion): # COMPLETAR
        ...
        for vecinos in habitacion.conexiones:
            vecinos.conexiones.remove(habitacion)
