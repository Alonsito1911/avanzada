...
class Simulacion:
    ...
    def nuevo_dia(self) -> None:
        ...
        recolector2 = Recolector("pedro", self.centro_urbano)
        constructor1 = Constructor("Alonso", self.centro_urbano)
        constructor2 = Constructor("Cris", self.centro_urbano)
        recolector1.start()
        recolector2.start()
        constructor1.start()
        constructor2.start()
